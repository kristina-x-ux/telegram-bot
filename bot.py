...
def get_preview_keyboard():
    kb = types.InlineKeyboardMarkup()
    kb.row(
        types.InlineKeyboardButton("🛒 Открыть корзину", callback_data="preview_cart"),
        types.InlineKeyboardButton("📋 Категории", callback_data="preview_categories")
    )
    return kb
